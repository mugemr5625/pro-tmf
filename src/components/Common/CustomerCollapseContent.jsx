    ...
    <>
            ...
            {customer.latitude && customer.longitude ? (
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <Button
                  type="link"
                  size="small"
                   icon={<img src={location2} alt="location" style={{ width: 16, height: 16 }} />}
      ...
      {customer.latitude && customer.longitude && (
        <LocationMapModal
          ...
          initialLocation={{
            lat: parseFloat(customer.latitude).toFixed(6),
            lng: parseFloat(customer.longitude).toFixed(6),
            address: `${parseFloat(customer.latitude).toFixed(6)}, ${parseFloat(customer.longitude).toFixed(6)}`
          }}
          editable={false}
